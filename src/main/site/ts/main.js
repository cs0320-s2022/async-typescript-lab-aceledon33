...
const sunH = document.getElementById("sun");
const moonH = document.getElementById("moon");
const risingH = document.getElementById("rising");
...
document.addEventListener("keyup", (ev) => __awaiter(void 0, void 0, void 0, function* () {
    if (ev.key == "k") {
        yield updateValues("Aquarius", "Sagittarius", "Cancer")
            .then(postAndUpdate);
    }
}));
